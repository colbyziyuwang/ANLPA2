...
model_path = "models/perceptron_stock_doc2vec.pkl"
doc2vec_path = "models/sec_doc2vec.model"
conf_matrix_path = "images/conf_matrix_perceptron_doc2vec.png"
...
_, test_files = train_test_split(csv_files, test_size=1 - train_ratio, random_state=SEED)

# ✅ Evaluation loop
all_preds, all_labels = [], []

for test_file in tqdm(test_files, desc="Evaluating Perceptron"):
...
plt.ylabel("Actual")
plt.title("Confusion Matrix - Perceptron + Doc2Vec")
plt.tight_layout()
